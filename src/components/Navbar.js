  ...
  function DropdownItemInternal(props) {
    ...
    return (
      <Link
        ...
        <span style={tits} className='icon-button'>
          {props.leftIcon}
        </span>
        {props.children}
  ...
  return (
    <div className='dropdown' style={{ height: menuHeight }} ref={dropdownRef}>
      <CSSTransition
        ...
        onEnter={calcHeight}>
        <div className='menu'>
          <DropdownItemInternal leftIcon={<HomeIcon />} to='1'>
            Home
      ...
      <CSSTransition
        ...
        <div className='menu'>
          ...
          <DropdownItem
            location='https://github.com/HarrisFauntleroy/marvel-react-app'
            leftIcon='🦸'>
            Marvel React App
          </DropdownItem>
          <DropdownItem
            location='https://github.com/HarrisFauntleroy/no-more-plants'
            leftIcon='🌿'>
            No More Plants!
          </DropdownItem>
          <DropdownItem
            location='https://github.com/HarrisFauntleroy/library-admin-panel'
            leftIcon='📖'>
            Library Admin Panel
          </DropdownItem>
          <DropdownItem
            location='https://github.com/HarrisFauntleroy/hermes'
            leftIcon='🚧'>
            Hermes (In-dev)
          </DropdownItem>
        </div>
      ...
      <CSSTransition
        ...
        <div className='menu'>
          ...
          <DropdownItem
            location='https://github.com/HarrisFauntleroy'
            leftIcon={<GithubIcon />}>
            Github
          </DropdownItem>
          <DropdownItem
            location='https://www.linkedin.com/in/harris-fauntleroy-b4b5b51b1/'
            leftIcon={<LinkedInIcon />}>
            LinkedIn
          </DropdownItem>
          <DropdownItem
            location='https://twitter.com/CosmicOctopus99'
            leftIcon={<TwitterIcon />}>
            Twitter
          </DropdownItem>
          <DropdownItem
            location='https://discord.gg/N4MGJGG7RA'
            leftIcon={<DiscordIcon />}>
            Discord
          </DropdownItem>
          <DropdownItem
            location='https://www.instagram.com/harrisfauntleroy/'
            leftIcon={<InstagramIcon />}>
            Instagram
          </DropdownItem>
          <DropdownItem
            location='https://www.instructables.com/member/HazzWold1993/'
            leftIcon={<InstructablesIcon />}>
            Instructables
          </DropdownItem>
        </div>
      </CSSTransition>
      ...
      <CSSTransition
        ...
        <div className='menu'>
          ...
          <DropdownItem
            location='https://mdigi.tools/color-shades/'
            leftIcon={<GithubIcon />}>
            Color Shade tool
          </DropdownItem>
          <DropdownItem
          ...
          <DropdownItem
            location='https://fontawesome.com/icons?d=gallery'
            leftIcon={<DiscordIcon />}>
            Font Awesome Icons
          </DropdownItem>
          <DropdownItem
            location='https://cdnjs.com/'
            leftIcon={<InstagramIcon />}>
            CDNJS
          </DropdownItem>
        </div>
