        ...
        <div className='container mx-auto flex flex-wrap items-center pt-18'>
          <div className='w-full xs:w-full sm:w-full md:w-6/12 lg:w-6/12 xl:w-6/12 2xl:px-16 xl:px-12 lg:px-10 px-10 md:px-4 sm:px-4 xs:px-12 mr-auto ml-auto xs:mt-32 sm:mt-32 md:mt-12'>
            ...
            <p className='text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700'>
              We love open source! 95% of the tools we use are free and open
              source. We work openly and we take pride in it. With no hidden
              source or technical jargon you can see the work that went into
              your project first hand.
            </p>
            ...
            <a
              href='https://share.hsforms.com/1hy5KUSAbS1GKx5oD7sVhoQ57353'
              target='_blank'
                  ...
                  <a
                    ...
                    <div className='bg-gray-100 shadow-lg rounded-lg text-center p-8 mt-8'>
                      <svg
                        ...
                        <path
                          fill='currentColor'
                          d='M277 170.7A85.35 85.35 0 0 0 277 0H106.3a85.3 85.3 0 0 0 0 170.6 85.35 85.35 0 0 0 0 170.7 85.35 85.35 0 1 0 85.3 85.4v-256zm0 0a85.3 85.3 0 1 0 85.3 85.3 85.31 85.31 0 0 0-85.3-85.3z'></path>
                      </svg>
                      <p className='text-lg text-grey mt-4 font-semibold'>
                        Figma
                      </p>
                  ...
                  <a
                    ...
                    <div className='bg-gray-100 shadow-lg rounded-lg text-center p-8 mt-8'>
                      <svg
                        ...
                        data-prefix='fab'
                        data-icon='linux'
                        class='svg-inline--fa fa-linux fa-w-14'
                        role='img'
                        xmlns='http://www.w3.org/2000/svg'
                        viewBox='0 0 448 512'>
                        <path
